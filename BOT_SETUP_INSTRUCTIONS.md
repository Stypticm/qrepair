...
### 3. **Menu Button НЕ настраиваем**
```
/setmenubutton
```

**Выберите "Remove Menu Button"** - никакого меню в левом нижнем углу не будет!

**Примечание:** Приложение открывается только через кнопки в чате и deep linking
...
✅ **В чате с ботом** НЕТ меню в левом нижнем углу  
...
### **Menu Button убран**
```typescript
// В @BotFather выбираем "Remove Menu Button"
// Никакого меню в левом нижнем углу не будет
```

## ✅ **Что нужно делать**

1. **Уберите Menu Button** через @BotFather (Remove Menu Button)
...
1. **НЕ настраивайте Menu Button** - никакого меню не должно быть

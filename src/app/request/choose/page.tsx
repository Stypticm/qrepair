  ...
  return (
    <Page back={true}>
      ...
      <section className="flex flex-col gap-4">
        <Button
          variant="outline"
          className="w-full bg-background text-black uppercase border-3 !border-slate-700 h-full py-8 rounded-xl"
          onClick={handleStart}
          disabled={loading}
        >
          <span className='text-2xl font-bold'>Заполнить в ручную</span>
        </Button>
        <Button
          variant="outline"

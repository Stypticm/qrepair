...
const MenuComponent = ({ userId, router, isLoading }: { userId: string | number | null, router: any, isLoading: boolean }) => {
    ...
    return (
        <div className="fixed left-1/2 -translate-x-1/2 z-[9999] pointer-events-none w-full max-w-[420px] px-4"
            style={{
        ...
        >
            <AnimatePresence mode="wait">
                {needsUpdate ? (
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-white/5 to-white/10 dark:from-white/5 dark:to-white/5 rounded-full blur-xl"></div>

                        <div className="relative bg-gradient-to-r from-white/8 via-white/12 to-white/8 dark:from-white/5 dark:via-white/10 dark:to-white/5 backdrop-blur-3xl border border-white/20 dark:border-white/10 rounded-full px-6 py-4 shadow-2xl">
                            <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent dark:from-white/5 dark:to-transparent rounded-full"></div>
                                    ...
                                    <>
                                        <div className="flex flex-1 justify-between items-center px-2">
                                            ...
                                            <button
                                                ...
                                                className="relative w-12 h-12 rounded-full bg-gradient-to-br from-white/40 to-white/20 dark:from-white/10 dark:to-white/5 backdrop-blur-sm flex items-center justify-center active:scale-95 transition-all duration-300 hover:from-white/50 hover:to-white/30 dark:hover:from-white/20 dark:hover:to-white/10 shadow-lg"
                                            ...
                                            >
                                                ...
                                                <DevicesIcon className="relative w-6 h-6 text-gray-800 dark:text-gray-200 drop-shadow-sm" />
                                            </button>
                                            ...
                                            >
                                                <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent dark:from-white/10 dark:to-transparent rounded-full"></div>
                                                <ShoppingCart className="relative w-6 h-6 text-gray-800 dark:text-gray-200 drop-shadow-sm" />
                                            </button>
                                            ...
                                            <button
                                                ...
                                                aria-label="Выйти"
                                            >
                                                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent dark:from-white/5 dark:to-transparent rounded-full"></div>

...
import { Users, BarChart3, Plus, ShoppingBag, MessageCircle, Smartphone, Wrench, LogOut } from 'lucide-react';
...
export function AdminSidebar() {
    ...
    return (
        <aside className="hidden md:flex flex-col w-64 min-h-screen bg-white border-r border-gray-100 pt-6 pb-8 sticky top-0">
            <div className="px-6 mb-8">
                ...
                <div className="mt-2 inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-gray-50 text-gray-400 text-[10px] font-bold uppercase tracking-widest">

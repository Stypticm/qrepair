...
export function getSectionsForRole(role: Role | null): string[] {
  switch (role) {
    case 'ADMIN':
      return ['staff', 'masters', 'requests', 'orders', 'add-lot', 'catalog', 'chats', 'leads', 'trade-in', 'repair', 'blog']
    case 'MANAGER':
      return ['requests', 'orders', 'add-lot', 'catalog', 'chats', 'leads', 'trade-in', 'repair', 'blog']
    case 'MASTER':
